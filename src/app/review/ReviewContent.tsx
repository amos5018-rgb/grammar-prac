          ...
          <div className="flex items-center gap-2 mb-4">
            <div ref={dropdownRef} className="relative flex-1 min-w-0">
              ...
              >
                ...
                <svg className={`w-4 h-4 text-text-secondary shrink-0 ml-2 transition-transform ${unitDropdownOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <button
              ...
              className={`shrink-0 text-xs px-3 py-2.5 rounded-xl border transition-colors ${
                sortByCount
