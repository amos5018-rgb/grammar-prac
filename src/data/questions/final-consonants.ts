...
export const finalConsonantsQuestions: Question[] = [
  ...
  {
    id: 'FC014', unitCode: 'final-consonants', type: '객관식', difficulty: '중',
    passage: '',
    question: "'바깥'의 발음으로 알맞은 것은?",
    choices: ['[바깥]', '[바깟]', '[바깓]', '[바깍]'],
    answer: '3',
    explanation: "받침 'ㅌ'은 어말에서 대표음 [ㄷ]으로 발음되므로 [바깓]입니다.",
  },
  {
    id: 'FC015', unitCode: 'final-consonants', type: '단답형', difficulty: '상',
    passage: '',
    question: "'무릎'을 소리 나는 대로 쓰면? (대괄호 없이)",
    choices: [],
    answer: '무릅',
    explanation: "받침 'ㅍ'은 어말에서 대표음 [ㅂ]으로 발음되므로 [무릅]입니다. 학습지의 '풀숲[풀숩]'과 같은 원리입니다.",
  },
  {
    id: 'FC016', unitCode: 'final-consonants', type: '객관식', difficulty: '상',
    passage: '',
    question: '다음 중 발음 표기가 잘못된 것은?',
    choices: ['무릎[무릅]', '들녘[들녁]', '풀숲[풀숩]', '빛[빗]'],
    answer: '4',
    explanation: "받침 'ㅊ'은 대표음 [ㄷ]으로 발음되므로 '빛'은 [빋]입니다. [빗]이라는 표기도 결국 같은 소리이지만, 발음 표기는 대표음 'ㄷ'을 사용해 [빋]으로 적습니다.",
  },
  {
